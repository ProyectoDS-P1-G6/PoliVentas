...
INSERT INTO
Pedidos(cantidad ,fecha,id_comprador,id_articulo, id_vendedor)
VALUES
(2, now(),1200000000, 1,1211111111),
(1, now(),1200000000, 2,1211111111),
(3, now(),1200000000, 3,1211111111),
(4, now(),1200000000, 4,1211111111),
(1, now(),1200000000, 1,1211111111),
(2, now(),1200000000, 2,1211111111);
